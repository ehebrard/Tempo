...
//#define DBG_BOUND (num_fails >= 7521)
//#define DBG_CBOUND (solver.num_fails >= 7521)
//#define DBG_CLBOUND (solver.num_fails >= 7521)
//#define DBG_BBOUND (solver.num_fails >= 7521)
////////////
...
//  #define DBG_SEF solver.num_cons_propagations >= 516115
