 ...
 * @tparam CRTPImplTArgs template arguments for the CRTP base class
 * implementation
 */
template <typename Implementation, template <typename...> typename CRTPImpl,
          typename... CRTPImplTArgs>
struct crtp {
  /**
