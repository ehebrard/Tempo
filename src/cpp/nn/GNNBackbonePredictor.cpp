...
namespace tempo::nn {
    ...
    PolicyConfig::PolicyConfig(double relaxationRatio, double reactivity, double minCertainty,
                               double minFailRatio, double maxFailRatio, bool carefulAssumptions,
                               unsigned int retryLimit, DecayMode decayMode) noexcept
    ...
    PolicyConfig::PolicyConfig() noexcept: relaxationRatio(1), reactivity(0.5), minCertainty(0.5),
                                           ...
                                           carefulAssumptions(false), retryLimit(0), decayMode(DecayMode::Constant) {}
